...
from gps_toll.simulation import DEFAULT_TOLL_RATE_PER_KM, TripResult, simulate_default_trip
...
class TollSimulatorApp:
    ...
    def start_simulation(self) -> None:
        ...
        self.result = simulate_default_trip(self.speed_kmh, self.toll_rate_per_km)
...
def run_app(
    ...
    root = tk.Tk()
    TollSimulatorApp(root, speed_kmh, toll_rate_per_km, map_file)
    root.mainloop()
